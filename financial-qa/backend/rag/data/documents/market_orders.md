...
> **Source:** [Wikipedia — Order (exchange)](https://en.wikipedia.org/wiki/Order_(exchange))
...
The use of stop orders is much more frequent for stocks and futures that trade on an exchange. Retail traders often rely on stop-loss orders in leveraged markets like futures and forex to manage downside risk and reduce emotional decision-making under pressure, than those that trade in the over-the-counter (OTC) market.
