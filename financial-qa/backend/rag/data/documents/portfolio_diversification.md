...
> **Source:** [Wikipedia — Diversification (finance)](https://en.wikipedia.org/wiki/Diversification_(finance))
...
.  If 
 ...
 are uncorrelated, the variance of portfolio return is 
    ...
    {\displaystyle {\text{var}}(qx+(1-q)y)=q^{2}\sigma _{x}^{2}+(1-q)^{2}\sigma _{y}^{2}}
...
.  The variance-minimizing value of 
 ...
 is 
    ...
    {\displaystyle q=\sigma _{y}^{2}/[\sigma _{x}^{2}+\sigma _{y}^{2}]}
...
.  Using this value of 
 ...
 in the expression for the variance of portfolio return gives the latter as 
    ...
    {\displaystyle \sigma _{x}^{2}\sigma _{y}^{2}/[\sigma _{x}^{2}+\sigma _{y}^{2}]}
...
Rearranging:
    ...
    {\displaystyle \sigma _{P}^{2}=\mathbb {E} \left[\sum _{i=1}^{n}\sum _{j=1}^{n}x_{i}x_{j}(R_
